...
const ManagerManagers = {
    template: ManagerManagersTemplate,
    data: function () {
        return {
            queryManagersForm: {
                pageNo: 1,
        ...
        queryManagers: function () {
            ...
            axios.get(MANAGER_ROOT_PATH + '/manager/manage/query', {params: this.queryManagersForm})
                .then(function (result) {
                    ...
                    result.infos.forEach(function (manager) {
                        manager.editing = false;
                        manager.editingType = null;
                        manager.editingName = null;
                        manager.showingSecretKey = false;
                    });
