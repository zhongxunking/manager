 ...
 */
@Service
public class QueryManagerRelationsService {
    @Autowired
    ...
    @ServiceBefore
    public void before(ServiceContext<QueryManagerRelationsOrder, QueryManagerRelationsResult> context) {
        QueryManagerRelationsOrder order = context.getOrder();
    ...
    @ServiceExecute
    public void execute(ServiceContext<QueryManagerRelationsOrder, QueryManagerRelationsResult> context) {
        QueryManagerRelationsOrder order = context.getOrder();
        QueryManagerRelationsResult result = context.getResult();
